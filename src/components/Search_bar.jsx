...
export const Search_bar=(props)=>
{
    ...
    <div class="relative border-cyan-500 lg:w-[50%] after:border-none md:w-[70%] w-[70%] xs:w-[60%]">
        <input onChange={handleChange} onKeyUp={handleSearch}   id="default-search" class="block w-full p-3 xs:p-4 ps-6 xs:ps-10 text-sm text-cyan-500  border-[3px] lg:text-[24px] md:text-[22px] border-cyan-500 rounded-[4px] xs:rounded-lg bg-transparent focus:cyan-500 border-solid outline-none  placeholder:text-cyan-500"
