...
import Popup from "./popupL"; // Import the Popup component

function Modal({ visible, onClose, moderatorName }) {
    ...
    <div className="fixed inset-0 bg-black bg-opacity-30 backdrop-blur-sm flex justify-center items-center">
      <div className="h-64 w-96 bg-sidebar  rounded flex flex-col justify-center items-center">
        ...
        <h2 className="text-item-col  text-[105%] text-center">
          Are you sure you want to delete {moderatorName} from the list of moderators ?
        </h2>
